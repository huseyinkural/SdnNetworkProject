        ...
        if len(fileName) > 0:
            ...
            for widget in self.widgetToItem:
                ...
                if 'LegacySwitch' in tags:
                    f.write(
                        "    " + name + " = net.addSwitch('" + name + "', cls=OVSKernelSwitch, failMode='standalone')\n")
                if 'Switch' in tags:
                    opts = self.switchOpts[name]
                ...
                if 'Host' in tags:
                    ...
                    if 'vlanInterfaces' in opts:
                        for vlanInterface in opts['vlanInterfaces']:
                            ...
                            f.write("    " + name + ".cmd('ifconfig " + name + "-eth0." + vlanInterface[1] + " " +
                                    vlanInterface[0] + "')\n")
...
r+Xl5rW2uHW61On1+UGpzbrf6xiXwny9166vsMLCwgBdlAmHt8TFxgBwpNTs9client2hyO7t7ZnR5L/B
w0yv0NXV1gBimKGjpABtoQBuoqKkpiaUvqWmqHbB2/j4+Pf39729vgB/sN7w9obH3hSMugCAsonJ
4M/q8wBglgB6rCCaxLO0tX7client2wBqniGMuABzpuPl5f3+/v39/fr6+r7i7vP6/ABonV621LLc6zWk
...
6wB2qdju9TWfxgBpniOcxeLj48vn8dvclient3VKuzwB2qp6fos/Q0aXV6D+jxwB7rsXHyLu8vb27vCSc
...
xKytr8G/wABypXvclient23vD3O73+3vE3cvU2PH5+7S1t7q7vCGVwO/v8JfM3zymyyyZwrWys+Hy90Ki
...
WhDEcOWxDwofv0zqHIhhDYIFclient2p4MYFMS62ZaiYVWlJJAYIqO00KMlEjABYOQokaRbp0CYBKffpE
iDpxSKYclient1gqswToUmYVaCFyp6QrgwwcCscaSJZhgQYBeAdRyqFBhgwWkGyct8WoXRZ8Ph/YOxMOB
...
1P/hzRw2IFJPGw3AAY0LI/SAwxc7jEKQI2mkEUipRoxp0g821AMIGlG0McockMzihx5client1LkDDmSg
UVAiafACRbGPVKDTFG3MYUYdLoThRxDE6DEMGUww8eQONGwTER9piFINFOPasaFJVIjTwclient1xzOGP
...
PlLITGFmmRkzP+DlVKHCmU9nnz45csSqKKsn9gileZKrVclient4aRFACOGZu5UobNuRohRkzhclient2b+36o
...
A6OBM4pXAhsl8FYELYWFWZhiZCbRQgIclient2AGTLy408coxAoEDx5wwtGPALTVg0E4NKC7gp4FsBKoA
Ki8U+oIVmVih6DnZPMBMAlGwIARWOLiggSYC+ZNIOulwY4AkSZCyxaikbqHMqaeaIp4+rAaxQxBg
2P+IozuRzvLZIS4syYVAfMAhwhSclient1EPCGoskIIYY9yS7Hny75OFnEIAGyiVvWkjjRxF11fXIG3WU
...
Z6BzBt30003Ps+AhNB5client4PCGC5gKJMMTZJBRytOl/CH1HxvQkMbVVxujtdZGGKGL17rsEfYQe+xR
...
tktjfQFu3TNxryx4xAMTIzOE1XqAh1uf5SWclient4AcfNy1XgQJny93n8a2trRh312Gt+VGm/AQIDTmB
...
rtwADuxCG/MOjwgRUEIjGG3FhaOBzaThiDSCil27G8Isclient3LLjZwXsA6YYJmDjhTMmseoKQIFDx7R
...
DAsQ0O7DzGIQzD2QdDEJHTsIAROclient3F7qWQncyHPPHN5QQAAG/vjzw8oKp8sPPxDH3O44/kwBQzLB
...
gGPLHwLwcMIo12Qxu0ABAQA7
        ...
        'Host': PhotoImage(data=r"""
            ...
            HEkQZsyCM0mmvGkw50uePUV2tEnOZkyfQA8iTYpTKNOgKJ+client3AhO
